...
namespace GHSprintTrax.GithubApi
{
    public class Organization : EntityImplementation
    {
        ...
        public string Name
        {
            get { return orgData.Name; }
        }

        public string Company
        {
            get { return orgData.Company; }
        }

        public string Blog
        {
            get { return orgData.Blog; }
        }

        public string Location
        {
            get { return orgData.Location; }
        }

        public string Email
        {
            get { return orgData.Email; }
        }

        public int PublicRepos
        {
            get { return orgData.PublicRepos; }
        }

        public int PublicGists
        {
            get { return orgData.PublicGists; }
        }

        public int Followers
        {
            get { return orgData.Followers; }
        }

        public int Following
        {
            get { return orgData.Following; }
        }

        public string HtmlUrl
        {
            get { return orgData.HtmlUrl; }
        }

        public DateTimeOffset CreatedAt
        {
            get { return orgData.CreatedAt; }
        }

        public string Type
        {
            get { return orgData.Type; }
        }
